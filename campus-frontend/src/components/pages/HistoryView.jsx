    ...
    <div className="space-y-4 p-5">
      <section className="rounded-3xl bg-slate-900 p-5 text-white shadow-lg">
        ...
        <div className="mt-4">
          ...
          <p className="mt-2 text-sm text-slate-300">查看你发布或完成过的任务，以及对应收入情况。</p>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <h3 className="line-clamp-2 text-base font-bold text-slate-900">{task.title || '未命名任务'}</h3>
                        <span className="rounded-full bg-white px-2.5 py-1 text-[11px] font-bold text-slate-500">#{task.id}</span>
                      </div>
                  ...
                  <div className="mt-3 space-y-2 rounded-2xl bg-white px-4 py-3 text-xs text-slate-500">
                    <p>{counterpartLabel}: {counterpartValue}</p>
